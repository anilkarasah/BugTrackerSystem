        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TrackStatusId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Bugs_Projects_RelatedProjectId",
                        column: x => x.RelatedProjectId,
                        principalTable: "Projects",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Bugs_Status_TrackStatusId",
                        column: x => x.TrackStatusId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Bugs_RelatedProjectId",
                table: "Bugs",
                column: "RelatedProjectId");

            migrationBuilder.CreateIndex(
                name: "IX_Bugs_TrackStatusId",
                table: "Bugs",
                column: "TrackStatusId");
